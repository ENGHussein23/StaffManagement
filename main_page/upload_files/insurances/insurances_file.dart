...
class Insurances_file extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return Insurances_fileState();
  }
}

class Insurances_fileState extends State<Insurances_file> {
  late File file;
  String filename='';
  @override
...
// Create a multipart request
                    var request = http.MultipartRequest(
                        'POST',
                        Uri.parse(
                            'https://emp.almatin.com/api/insurance/import'));
