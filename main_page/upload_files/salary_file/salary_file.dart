...
class Salary_file extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return Salary_fileState();
  }
}

class Salary_fileState extends State<Salary_file> {
  late File file;
  String filename='';
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextButton(
              onPressed: () async {
                var request = http.MultipartRequest('POST', Uri.parse('https://emp.almatin.com/api/salary/import'));
...
// Send request
                ...
                if (response.statusCode == 200) {   // check the status code
          ...
          //     color: Color.fromARGB(136, 72, 136, 255),
          //     size: 50,
          //   ),
          // ),
