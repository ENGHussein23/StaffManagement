...
class Follow_file extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return Follow_fileState();
  }
}

class Follow_fileState extends State<Follow_file> {
  late File file;
  String filename = '';
...
// Create a multipart request
                    var request = http.MultipartRequest(
                        'POST',
                        Uri.parse(
                            'https://emp.almatin.com/api/followup/import'));
